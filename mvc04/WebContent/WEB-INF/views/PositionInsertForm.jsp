	...
	<div id="content">
		...
		<form action="positioninsert.action" method="post" id="positionForm">
			...
			<tr>
				<th>직위 이름</th>
				<td>
					<input type="text" name="positionName" placeholder="직위 이름" id="positionName" />	
				</td>
			</tr>
			<tr>
				<th>최소 기본급</th>
				<td><input type="text" id="minBasicPay" placeholder="최소 기본급" name="minBasicPay" /></td>
			</tr>
			<tr>
